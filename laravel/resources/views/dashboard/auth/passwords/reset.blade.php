                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form method="POST" action="{{ route('password.update') }}" class="auth-login-form mt-2" >
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="login-email" required autocomplete="email" autofocus tabindex="1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="login-password" required autofocus tabindex="2">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="login-confirm">Password</label>
                                        <input type="password" class="form-control" name="password_confirmation" id="login-confirm" required autofocus tabindex="3">
                                    </div>

                                    <button class="btn btn-primary btn-block" tabindex="4">{{ __('Reset Password') }}</button>
                                </form>
