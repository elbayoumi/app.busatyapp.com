                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="lang" name="lang" class="form-control">
                                                ...
                                                <option value="en" {{ old('lang', $question->lang ?? '') == 'en' ? 'selected' : '' }}>English</option>
                                                <option value="ar" {{ old('lang', $question->lang ?? '') == 'ar' ? 'selected' : '' }}>Arabic</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="type" name="type" class="form-control">
                                                ...
                                                <option value="parents" {{ old('type', $question->type ?? '') == 'parents' ? 'selected' : '' }}>Parents</option>
                                                <option value="schools" {{ old('type', $question->type ?? '') == 'schools' ? 'selected' : '' }}>Schools</option>
                                                <option value="attendants" {{ old('type', $question->type ?? '') == 'attendants' ? 'selected' : '' }}>Attendants</option>
                                            </select>
                                        </div>
                                    </div>
