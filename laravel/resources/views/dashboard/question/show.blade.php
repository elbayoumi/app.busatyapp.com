    ...
    <section class="app-user-edit">
        <div class="card">
            <div class="card-header border-bottom">
                <h4 class="card-title"> عرض السؤال شائع</h4>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <input  disabled type="text" class="form-control" placeholder="lang" value="{{ $question->lang }}"
                                          name="lang" id="lang" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  disabled type="text" class="form-control" placeholder="question" value="{{ $question->question }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea disabled name="answer" class="form-control" id="answer" cols="40" rows="10">{{ $question->answer }}</textarea>
