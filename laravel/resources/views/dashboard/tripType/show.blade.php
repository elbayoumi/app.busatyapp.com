    ...
    <section class="app-user-edit">
        <div class="card">
            <div class="card-header border-bottom">
                <h4 class="card-title"> عرض نوع الرحلة الافتراضي</h4>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  disabled type="text" class="form-control" placeholder="name" value="{{ $tripType->name }}"
                                                name="name" id="name" />
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea disabled name="description" class="form-control" id="description" cols="40" rows="10">{{ $tripType->description }}</textarea>
