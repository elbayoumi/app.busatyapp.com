    ...
    <section class="app-user-edit">
        <div class="card">
            <div class="card-header border-bottom">
                <h4 class="card-title"> تعديل بيانات الاعلان</h4>
                ...
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <form action="{{ route('dashboard.adesSchool.update', $ades->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="alt" name="alt"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <img class="w-25 rounded-circle" src="{{ $ades?->image_path }}" alt="{{ $ades?->alt }}">
                                        </div>
                                    </div>
